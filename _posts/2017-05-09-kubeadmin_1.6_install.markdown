...
[docker-thinpool.profile](https://github.com/sd018/kuadeadm_install/blob/master/docker-thinpool.profile)
...
配置Docker daemon
[daemon.json](https://github.com/sd018/kuadeadm_install/blob/master/daemon.json)
...
######部署weavescope
    ...
    [root@vm-shalku91 k8s]# kubectl apply -f weavescope.yaml  --namespace="kube-system"
