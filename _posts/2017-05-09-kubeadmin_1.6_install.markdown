...
```
yaml文件:[kube-flannel.yml](https://github.com/sd018/kuadeadm_install/blob/master/kube-flannel.yml)[kube-flannel-rbac.yml](https://github.com/sd018/kuadeadm_install/blob/master/kube-flannel-rbac.yml)
